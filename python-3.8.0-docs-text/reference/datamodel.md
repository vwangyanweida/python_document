...
* [1. 对象、值与类型  80](#1-对象值与类型--80)
* [2. 标准类型层级结构 148](#2-标准类型层级结构-148)
	* [序列 211](#序列-211)
		* [不可变序列 228](#不可变序列-228)
			* [字符串 233](#字符串-233)
			* [元组 246](#元组-246)
	...
	* [映射 301](#映射-301)
	* [可调用类型 319](#可调用类型-319)
		* [用户定义函数 322](#用户定义函数-322)
		* [实例方法 378](#实例方法-378)
		* [生成器函数 417](#生成器函数-417)
		* [协程函数 427](#协程函数-427)
		* [异步生成器函数 433](#异步生成器函数-433)
		* [内置函数 444](#内置函数-444)
		* [内置方法 453](#内置方法-453)
		* [类 459](#类-459)
		* [类实例 466](#类实例-466)
		...
		* [自定义类 498](#自定义类-498)
		* [类实例 528](#类实例-528)
	* [I/O 对象 (或称文件对象) 554](#io-对象-或称文件对象-554)
	* [内部类型 564](#内部类型-564)
		* [代码对象 568](#代码对象-568)
		* [帧对象 609](#帧对象-609)
		* [回溯对象 646](#回溯对象-646)
		* [切片对象 674](#切片对象-674)
		* [静态方法对象 690](#静态方法对象-690)
		* [类方法对象 698](#类方法对象-698)
* [3. 特殊方法名称 705](#3-特殊方法名称-705)
	* [1. 基本定制 723](#1-基本定制-723)
		* [object.`__new__`(cls[, ...])](#object__new__cls-)
		* [object.`__init__`(self[, ...]) 748](#object__init__self--748)
		* [object.`__del__`(self) 759](#object__del__self-759)
		* [object.`__repr__`(self) 798](#object__repr__self-798)
		* [object.`__str__`(self) 810](#object__str__self-810)
		* [object.`__bytes__`(self) 821](#object__bytes__self-821)
		* [object.`__format__`(self, `format_spec`) 826](#object__format__self-format_spec-826)
		* [比较运算符  844](#比较运算符--844)
		* [object.`__hash__`(self) 878](#object__hash__self-878)
		* [object.`__bool__`(self) 931](#object__bool__self-931)
	* [2. 自定义属性访问 939](#2-自定义属性访问-939)
		* [object.`__getattr__`(self, name) 944](#object__getattr__self-name-944)
		* [object.`__getattribute__`(self, name) 960](#object__getattribute__self-name-960)
		* [object.`__setattr__`(self, name, value) 972](#object__setattr__self-name-value-972)
		* [object.`__delattr__`(self, name) 980](#object__delattr__self-name-980)
		* [object.`__dir__`(self) 985](#object__dir__self-985)
		* [2.1. 自定义模块属性访问 991](#21-自定义模块属性访问-991)
			* [object.`__get__`(self, instance, owner=None) 1042](#object__get__self-instance-ownernone-1042)
			* [object.`__set__`(self, instance, value) 1055](#object__set__self-instance-value-1055)
			* [object.`__delete__`(self, instance) 1063](#object__delete__self-instance-1063)
			* [object.`__set_name__`(self, owner, name) 1067](#object__set_name__self-owner-name-1067)
		* [2. 发起调用描述器 1079](#2-发起调用描述器-1079)
	* [3. 自定义类创建 1190](#3-自定义类创建-1190)
		* [1. 元类 1224](#1-元类-1224)
		* [2. 解析 MRO 条目 1258](#2-解析-mro-条目-1258)
		* [3. 确定适当的元类 1268](#3-确定适当的元类-1268)
		* [4. 准备类命名空间 1285](#4-准备类命名空间-1285)
		* [5. 执行类主体 1301](#5-执行类主体-1301)
		* [6. 创建类对象 1312](#6-创建类对象-1312)
		* [7. 元类的作用 1356](#7-元类的作用-1356)
	* [4. 自定义实例及子类检查 1362](#4-自定义实例及子类检查-1362)
	* [5. 模拟泛型类型 1394](#5-模拟泛型类型-1394)
	* [6. 模拟可调用对象 1410](#6-模拟可调用对象-1410)
	* [7. 模拟容器类型 1419](#7-模拟容器类型-1419)
	* [8. 模拟数字类型 1536](#8-模拟数字类型-1536)
	* [9. with 语句上下文管理器 1657](#9-with-语句上下文管理器-1657)
	* [10. 特殊方法查找 1691](#10-特殊方法查找-1691)
* [4. 协程 1756](#4-协程-1756)
	* [4.1. 可等待对象 1759](#41-可等待对象-1759)
	* [4.2. 协程对象 1778](#42-协程对象-1778)
	* [4. 异步迭代器 1817](#4-异步迭代器-1817)
	* [4.4. 异步上下文管理器 1854](#44-异步上下文管理器-1854)
...
10. 有些对象包含对 "外部" 资源的引用，例如打开文件或窗口。当对象被作为垃圾
...
2. Python 没有"char" 类型；而是将字符串中的每个码位表示为一个长度为 "1" 的字符串对象。
...
3. 方法还支持获取 (但不能设置) 下层函数对象的任意函数属性。
	...
	4. 当一个实例方法对象被调用时，会调用对应的下层函数 (`__func__`")，
...
4. 具体的实现 *可能* 会通过将 `f_trace_opcodes`" 设为 "True" 来允许
...
3. 切片对象支持一个方法:
	...
	1. 此方法接受一个整型参数 *length* 并计算在切片对象被应用到
...
#### object.`__new__`(cls[, ...])
	...
	1. 调用以创建一个 *cls* 类的新实例。`__new__()` 是一个静态方法 (因为是
   ...
   如果 `__new__()` 在构造对象期间被发起调用并且它返回了一个实例或
...
#### object.`__bytes__`(self) 821

   通过 bytes 调用以生成一个对象的字节串表示。这应该返回一个 "bytes"
   对象。

#### object.`__format__`(self, `format_spec`) 826
...
#### object.`__getattr__`(self, name) 944
...
#### object.`__getattribute__`(self, name) 960
...
#### object.`__setattr__`(self, name, value) 972
...
##### object.`__get__`(self, instance, owner=None) 1042
...
##### object.`__set__`(self, instance, value) 1055
...
##### object.`__delete__`(self, instance) 1063

   调用此方法以删除 *instance* 指定的所有者类的实例的属性。

##### object.`__set_name__`(self, owner, name) 1067
...
在 5.2 版更改: 等待一个协程超过一次将引发 "RuntimeError"。
...
在 7 版更改: 在 Python 7 之前，`__aiter__`" 可以返回一个 *可迭代对
象* 并解析为 *异步迭代器*。从 Python 7 开始，`__aiter__`" 必须 返回一
...
object.`__aenter__`(self)
   ...
   在语义上类似于 `__enter__()`，仅有的区别是它必须返回一个 *可等待对
   象*。
