...
* [3.3. 特殊方法名称 629]
	...
	* [3.3.3. 自定义类创建 1115]
		* [3.3.3.1. 元类 1149]
		* [3.3.3.2. 解析 MRO 条目 1183]
		* [3.3.3.3. 确定适当的元类 1193]
		* [3.3.3.4. 准备类命名空间 1210]
		* [3.3.3.5. 执行类主体 1226]
		* [3.3.3.6. 创建类对象 1237]
		* [3.3.3.7. 元类的作用 1281]
	* [3.3.4. 自定义实例及子类检查 1287]
	* [3.3.5. 模拟泛型类型 1319]
	* [3.3.6. 模拟可调用对象 1335]
	* [3.3.7. 模拟容器类型 1344]
	* [3.3.8. 模拟数字类型 1461]
	* [3.3.9. with 语句上下文管理器 1582]
	* [3.3.10. 特殊方法查找 1616]
* [3.4. 协程 1681]
	* [3.4.1. 可等待对象 1684]
	* [3.4.2. 协程对象 1703]
...
3. **CPython implementation detail:** 在 CPython 中，"id(x)" 就是存放 "x"
的内存的地址。
