...
内部类型
   ...
   代码对象
      ...
      特殊的只读属性: `co_name`" 给出了函数名称; `co_argcount`" 为位置参
      数的总数量 (包括有仅限位置参数和带有默认值的参数);
   ...
   帧对象
      ...
      特殊的可写属性: `f_trace`"，如果不为 "None"，则是在代码执行期间调
